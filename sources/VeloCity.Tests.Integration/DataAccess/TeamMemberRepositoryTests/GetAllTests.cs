...
public class GetAllTests
{
    ...
    [Fact]
    public async Task HavingDatabaseWithTeamMembers_WhenGetAll_ThenReturnsTeamMemberWithSpecifiedId()
    {
    ...
    [Fact]
    public async Task HavingEmptyDatabase_WhenGetAll_ThenReturnsEmptyEnumeration()
    {
        await DatabaseTestContext
