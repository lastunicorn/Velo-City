...
namespace DustInTheWind.VeloCity.Tests.Unit.Wpf.Presentation.Styles.Converters.SprintStateToTextConverterTests;
...
public class Convert_FromObjectTests
{
    ...
    [Fact]
    public void HavingNullValue_WhenConverting_ThenReturnsUnsetValue()
    {
        object value = null;

        object actual = converter.Convert(value, null, null, null);
