...
public class Convert_FromNullableBoolTests
{
    private readonly BooleanToVisibilityInverseConverter converter;

    public Convert_FromNullableBoolTests()
    {
    ...
    [Fact]
    public void HavingNullableTrueValue_WhenConverting_ThenReturnsCollapsed()
    {
        bool? value = true;
    ...
    [Fact]
    public void HavingNullableFalseValue_WhenConverting_ThenReturnsVisible()
    {
        bool? value = false;
