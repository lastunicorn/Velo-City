...
public class ConstructorTests
{
    ...
    public void HavingNullUnitOfWork_WhenInstantiatingUseCase_ThenThrows()
    {
        ...
        Action action = () =>
        {
            _ = new PresentTeamMemberVacationsUseCase(null, applicationState);
        };
    ...
    public void HavingNullApplicationState_WhenInstantiatingUseCase_ThenThrows()
    {
        ...
        Action action = () =>
        {
            _ = new PresentTeamMemberVacationsUseCase(unitOfWork.Object, null);
        };
    ...
    public void HavingAllDependencies_WhenInstantiatingUseCase_ThenDoesNotThrow()
    {
        ...
        Action action = () =>
        {
            _ = new PresentTeamMemberVacationsUseCase(unitOfWork.Object, applicationState);
        };
