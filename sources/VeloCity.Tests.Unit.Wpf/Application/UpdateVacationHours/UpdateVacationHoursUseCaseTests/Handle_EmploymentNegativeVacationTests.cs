...
public class Handle_EmploymentNegativeVacationTests
{
    private readonly UpdateVacationHoursUseCase useCase;
    private readonly TeamMember teamMember;
    private readonly EventBus eventBus;

    public Handle_EmploymentNegativeVacationTests()
    {
    ...
    [Fact]
    public async Task HavingTeamMemberWithNegativeVacationAndRequestWithPositiveHours_WhenExecutingTheUseCase_ThenVacationIsUpdated()
    {
        UpdateVacationHoursRequest request = new()
        {
            Date = new DateTime(2023, 03, 26),
    ...
    [Fact]
    public async Task HavingTeamMemberWithNegativeVacationAndRequestWithPositiveHours_WhenExecutingTheUseCase_ThenTeamMemberVacationChangedEventIsPublished()
    {
        EventBusClient<TeamMemberVacationChangedEvent> eventBusClient = eventBus.CreateMockSubscriberFor<TeamMemberVacationChangedEvent>();
