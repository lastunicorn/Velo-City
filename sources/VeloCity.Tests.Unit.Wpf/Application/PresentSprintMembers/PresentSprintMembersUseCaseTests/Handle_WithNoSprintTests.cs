...
namespace DustInTheWind.VeloCity.Tests.Unit.Wpf.Application.PresentSprintMembers.PresentSprintMembersUseCaseTests;
...
public class Handle_WithNoSprintTests
{
    ...
    [Fact]
    public async Task HavingNoSprintSpecifiedInApplicationState_WhenUseCaseIsExecuted_ThenLastInProressSprintIsRetrievedFromRepository()
    {
        sprintRepository
