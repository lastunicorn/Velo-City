...
namespace DustInTheWind.VeloCity.Tests.Unit.Wpf.Application.CanCloseSprint.CanCloseSprintUseCaseTests;
...
public class ConstructorTests
{
    ...
    public void HavingNullUnitOfWork_WhenInstantiatingUseCase_ThenThrows()
    {
        ...
        Action action = () =>
        {
            _ = new CanCloseSprintUseCase(null, applicationState);
        };
    ...
    public void HavingNullApplicationState_WhenInstantiatingUseCase_ThenThrows()
    {
        ...
        Action action = () =>
        {
            _ = new CanCloseSprintUseCase(unitOfWork.Object, null);
        };
    ...
    public void HavingAllDependencies_WhenInstantiatingUseCase_ThenDoesNotThrow()
    {
        ...
        Action action = () =>
        {
            _ = new CanCloseSprintUseCase(unitOfWork.Object, applicationState);
        };
