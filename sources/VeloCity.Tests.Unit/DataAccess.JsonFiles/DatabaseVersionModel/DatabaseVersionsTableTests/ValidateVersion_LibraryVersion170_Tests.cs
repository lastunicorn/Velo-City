...
public class ValidateVersion_LibraryVersion170_Tests
{
    [Fact]
    public void HavingLibraryVersion170_WhenValidatingDatabaseVersionNull_ThenReturnsWarning()
    {
        Version libraryVersion = new(1, 7, 0);
    ...
    [Fact]
    public void HavingLibraryVersion170_WhenValidatingDatabaseVersion010_ThenReturnsError()
    {
        Version libraryVersion = new(1, 7, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
    ...
    [Fact]
    public void HavingLibraryVersion170_WhenValidatingDatabaseVersion100_ThenReturnsError()
    {
        Version libraryVersion = new(1, 7, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
    ...
    [Fact]
    public void HavingLibraryVersion170_WhenValidatingDatabaseVersion110_ThenReturnsError()
    {
        Version libraryVersion = new(1, 7, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
    ...
    [Fact]
    public void HavingLibraryVersion170_WhenValidatingDatabaseVersion200_ThenReturnsNoErrorNoWarning()
    {
        Version libraryVersion = new(1, 7, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
    ...
    [Fact]
    public void HavingLibraryVersion170_WhenValidatingDatabaseVersion210_ThenReturnsWarning()
    {
        Version libraryVersion = new(1, 7, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
