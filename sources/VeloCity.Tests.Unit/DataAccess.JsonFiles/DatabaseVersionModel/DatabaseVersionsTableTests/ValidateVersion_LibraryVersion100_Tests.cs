...
public class ValidateVersion_LibraryVersion100_Tests
{
    [Fact]
    public void HavingLibraryVersion100_WhenValidatingDatabaseVersionNull_ThenReturnsWarning()
    {
    ...
    [Fact]
    public void HavingLibraryVersion100_WhenValidatingDatabaseVersion010_ThenReturnsNoErrorOrWarning()
    {
        Version libraryVersion = new(1, 0, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
    ...
    [Fact]
    public void HavingLibraryVersion100_WhenValidatingDatabaseVersion100_ThenReturnsNoErrorOrWarning()
    {
        Version libraryVersion = new(1, 0, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
    ...
    [Fact]
    public void HavingLibraryVersion100_WhenValidatingDatabaseVersion110_ThenReturnsWarning()
    {
        Version libraryVersion = new(1, 0, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
    ...
    [Fact]
    public void HavingLibraryVersion100_WhenValidatingDatabaseVersion200_ThenReturnsError()
    {
        Version libraryVersion = new(1, 0, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
    ...
    [Fact]
    public void HavingLibraryVersion100_WhenValidatingDatabaseVersion210_ThenReturnsError()
    {
        Version libraryVersion = new(1, 0, 0);
        DatabaseVersionsTable databaseVersionsTable = new(libraryVersion);
