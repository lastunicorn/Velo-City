...
public class SetVacation_CurrentDayNone_Create_PrevOnceSame_NextDailyDiffTests
{
    ...
    [Fact]
    public void HavingPrevOnceSameNextDailyDiff_WhenSettingVacationForCurrentDay_ThenCurrentDayVacationSpansFromPrevToCurrent()
    {
    ...
    [Fact]
    public void HavingPrevOnceSameNextDailyDiff_WhenSettingVacationForCurrentDay_ThenCurrentDayVacationHasCorrectHours()
    {
        vacationCollection.SetVacation(currentDate, 8);
    ...
    [Fact]
    public void HavingPrevOnceSameNextDailyDiff_WhenSettingVacationForCurrentDay_ThenOldPreviousDayVacationIsRemoved()
    {
        vacationCollection.SetVacation(currentDate, 8);
    ...
    [Fact]
    public void HavingPrevOnceSameNextDailyDiff_WhenSettingVacationForCurrentDay_ThenPreviousDayVacationIsSameAsCurrent()
    {
        vacationCollection.SetVacation(currentDate, 8);
    ...
    [Fact]
    public void HavingPrevOnceSameNextDailyDiff_WhenSettingVacationForCurrentDay_ThenPreviousVacationDoesNotTriggerChangedEventAnymore()
    {
        vacationCollection.SetVacation(currentDate, 8);
    ...
    [Fact]
    public void HavingPrevOnceSameNextDailyDiff_WhenSettingVacationForCurrentDay_ThenNextVacationStillTriggersChangedEvent()
    {
        vacationCollection.SetVacation(currentDate, 8);
    ...
    [Fact]
    public void HavingPrevOnceSameNextDailyDiff_WhenSettingVacationForCurrentDay_ThenCurrentVacationTriggersChangedEvent()
    {
        vacationCollection.SetVacation(currentDate, 8);
