...
public class Intersect_InfiniteLimits_WithInfiniteEnd_Tests
{
    [Fact]
    public void HavingInfiniteInterval_WhenIntersectingWithInfiniteEnd_ThenReturnsSecondInterval()
    {
        // ====================================================
        // --------------------------[=========================
