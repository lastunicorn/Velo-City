...
public class Intersect_FiniteLimits_WithInfiniteLimits_Tests
    {
        [Fact]
    public void HavingFiniteInterval_WhenIntersectingWithFullInfinite_ThenReturnsInitialInterval()
    {
        // --------------------[==========]--------------------
        // ====================================================
