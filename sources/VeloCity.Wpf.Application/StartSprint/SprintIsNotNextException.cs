...
public class SprintIsNotNextException : Exception
{
    public SprintIsNotNextException(int sprintNumber)
    ...
    {
        const string messageTemplate = "The sprint {0} cannot be started because it is not the next sprint.";
