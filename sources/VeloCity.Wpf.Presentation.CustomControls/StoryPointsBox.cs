...
namespace DustInTheWind.VeloCity.Wpf.Presentation.CustomControls
{
    public class StoryPointsBox : Control
    {
        ...
        private static readonly DependencyPropertyKey IsNullPropertyKey = DependencyProperty.RegisterReadOnly(
            ...
            typeof(bool),
            typeof(StoryPointsBox),
            new FrameworkPropertyMetadata(true, flags: FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender)
        );
        ...
        private static readonly DependencyPropertyKey WholePartPropertyKey = DependencyProperty.RegisterReadOnly(
            ...
            typeof(int),
            typeof(StoryPointsBox),
            new FrameworkPropertyMetadata(0, flags: FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender)
        );
        ...
        private static readonly DependencyPropertyKey FractionalPartPropertyKey = DependencyProperty.RegisterReadOnly(
            ...
            typeof(float),
            typeof(StoryPointsBox),
            new FrameworkPropertyMetadata(0f, flags: FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender)
        );
