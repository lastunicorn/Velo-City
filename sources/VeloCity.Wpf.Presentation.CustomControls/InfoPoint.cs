...
public class InfoPoint : ContentControl
{
    ...
    public static readonly DependencyProperty SpaceBetweenContentAndIconProperty = DependencyProperty.Register(
        ...
        typeof(double),
        typeof(InfoPoint),
        new FrameworkPropertyMetadata(8d, FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsRender, HandleSpaceBetweenContentAndIconPropertyChanged)
    );
